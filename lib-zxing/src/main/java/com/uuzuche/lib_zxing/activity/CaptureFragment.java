...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        seekbar = (SeekBar) view.findViewById(R.id.zoom_seek_bar);
    ...
    public void onResume() {
        ...
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int y, boolean b) {
//
                Camera.Parameters parameters = camera.getParameters();
                parameters.setZoom(y); // My device support some values in the range 100 | 400
        ...
        try {
           ...
           camera.setZoomChangeListener(new Camera.OnZoomChangeListener() {
               ...
               public void onZoomChange(int i, boolean b, Camera camera) {
                   Camera.Parameters parameters = camera.getParameters();
                   parameters.setZoom(i); // My device support some values in the range 100 | 400
                   parameters.setFocusMode(Camera.Parameters.FOCUS_MODE_INFINITY);
//            parameters.setVideoStabilization(false);
